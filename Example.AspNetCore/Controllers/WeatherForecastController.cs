...
public partial class WeatherForecastController : ControllerBase
{
    ...
    )
    {
        ...
        this._logger = logger;
        this._activitySource = instrumentationSource.ActivitySource;
        this._freezingDaysCounter = instrumentationSource.FreezingDaysCounter;
    }
    ...
    public async Task<IEnumerable<WeatherForecast>> Get()
    {
        ...
        _ = await this._httpClient.GetStringAsync(RequestUri);
        ...
        this._freezingDaysCounter.Add(forecast.Count(f => f.TemperatureF < 0));

        Logger.WeatherForecastGenerated(this._logger, forecast.Length, forecast);
